...
class PfisGraphWithVariants(PfisGraph):
	def __init__(self, dbFilePath, isVariantTopology, langHelper, projSrc, stopWords=[], verbose=False):
		PfisGraph.__init__(self, dbFilePath, isVariantTopology, langHelper, projSrc, stopWords, verbose)
